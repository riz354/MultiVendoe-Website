                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ $product->getFirstMediaUrl('product_images') }}" alt="Image">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    @if ($discounted_pric > 0)
                        <h5>Rs. {{ $discounted_pric }}</h5>
                        <h6 class="text-muted ml-2"><del>Rs.{{ $product->product_price }}</del></h6>
                    @else
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <form>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="{{$e->size}}" name="size">
                                <label class="custom-control-label" for="{{$e->size}}">{{$e->size}}</label>
                            </div>
                            @endforeach
                            {{-- <div class="custom-control custom-radio custom-control-inline">
